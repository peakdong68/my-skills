...
Use the project's registered decision owner and ADR format first. If change records own the decision, update that record without an ADR duplicate. For independent ADRs without a project convention, use `docs/adr/` and sequential numbering: `0001-slug.md`, `0002-slug.md`, etc.
