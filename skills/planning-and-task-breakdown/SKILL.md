...
将经过验证的计划文档保存至：`docs/spec/feature_<date>_<id>_<topic>/plan-1.md`——计划文档本身就是任务清单，不单独生成 todo.md。
...
将经过验证的计划文档保存至 `docs/spec/feature_<date>_<id>_<topic>/plan-1.md`。文档结构遵循 `assets/plan-template.md`——在撰写前必须先读取模板文件。计划文档本身就是任务清单（含所有 [ ] checkbox），不单独生成 todo.md。
