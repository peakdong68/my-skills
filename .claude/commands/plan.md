...
阅读现有规范（`docs/spec/feature_<date>_<id>_<topic>/spec-design.md`）以及相关代码库部分。然后：
...
撰写任务计划文档，产物保存至：`docs/spec/feature_<date>_<id>_<topic>/plan-1.md`——计划文档本身就是任务清单，不单独生成 todo.md。
