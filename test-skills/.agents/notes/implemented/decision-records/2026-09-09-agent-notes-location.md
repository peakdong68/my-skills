...
# Agent Note：Agent Notes 迁移至 .agents/notes

## 问题

此前规则没有区分通用 Agent Notes 资源位置与本仓库历史位置，默认路径变化可能被误解为要求其他项目迁移。
...
参见 [Agent Notes 规则](../../README.md)、[setup 配置](../../../../skills/user-invoked/setup-matt-pocock-skills/decision-records.md)、[工件位置样板](https://github.com/peakdong68/my-skills/blob/dc2212e2853bbc98cb187e134c7fb411cb55e361/test-skills/skills/user-invoked/setup-matt-pocock-skills/artifacts.md)。本次更新默认物理位置，沿用 [工件注册方法](./2026-09-08-artifact-location-registration.md) 中保留历史归属和显式迁移的原则。

<!-- agent-note-format: alternatives-not-recorded (pre-format Agent Note) -->

## 后果

本仓库将 Agent Notes 与脚本放在新的默认位置；其他项目仍保留已注册的历史位置，迁移需明确授权。
