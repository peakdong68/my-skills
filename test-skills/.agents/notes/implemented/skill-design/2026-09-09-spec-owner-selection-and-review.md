...
# Agent Note：Spec 复用已有合同并完成必要评审

## 问题

to-spec 可能重复已有规划合同，或在形成文档后仅自检而未完成必要评审。
...
情境核对确认：已有充分合同复用、同范围 Spec 更新、显式独立文档的引用或迁移、访谈首次成文不先造规划产物、重大决策缺口不自行补全、既有有效审查复用、首次成文与变更实际评审、必要评审受阻如实记录，以及独立规范交付不等于整体 Plan Review 或执行授权。此为文义核对，未运行代理行为测试。
...
to-spec 优先复用合同属主，按变化执行实际评审；文档就绪、评审、批准和实施授权仍彼此独立。
